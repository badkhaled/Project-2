...
public class CharacterNameGenerator : ScriptableObject
{
    ...
    public CharacterName[] GenerateNames(int namesNeeded)
    {
        ...
        for (int i = 0; i < names.Length; i++)
        {
            ...
            CharacterName RandomName = new CharacterName(firstname,lastNames[Random.Range(0, lastNames.Count)], nicknames[Random.Range(0, nicknames.Count)], descriptors[Random.Range(0, descriptors.Count)]);
            names[i] = RandomName;
        }
